...
$(function(){
	...
	//첫번째로 업로드한 이미지 저장
	$("#mypageReviewForm").submit(function(){
...
<div class="container">
<br><br>
	<form method="post" action="mypageReviewEditOk" id="mypageReviewForm" enctype="multipart/form-data">
		<input type="hidden" name="plan_no" value="${dto.plan_no }">
		<input type="hidden" id="thumbnail" name="thumbnail" value="">
		<ul>
			<div style="text-align:center">
				<li><input type="text" name="review_subject" id="review_subject" value="${dto.review_subject }" placeholder="제목을 입력하세요. (30자 이내)" maxlength="30"></li>
			</div>
			<li>
		...
		<a href="/jejuana/mypage/mypageReview">목록</a>
